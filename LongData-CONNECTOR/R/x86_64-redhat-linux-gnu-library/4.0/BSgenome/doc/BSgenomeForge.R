...
###################################################
### code chunk number 2: BSgenomeForge.Rnw:422-433
###################################################
library(BSgenome)
...
###################################################
### code chunk number 3: BSgenomeForge.Rnw:446-448 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 4: BSgenomeForge.Rnw:671-676
###################################################
library(BSgenome)
seed_files <- system.file("extdata", "GentlemanLab", package="BSgenome")
...
###################################################
### code chunk number 5: BSgenomeForge.Rnw:691-693 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 6: BSgenomeForge.Rnw:735-736
###################################################
sessionInfo()
